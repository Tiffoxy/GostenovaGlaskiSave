...
namespace WpfApp1
{
    ...
    public partial class GostenovaKREntities : DbContext
    {
        private static GostenovaKREntities _context;

        public static GostenovaKREntities GetContext()
        {
            if (_context == null)
                _context = new GostenovaKREntities();
            return _context;
        }
        public GostenovaKREntities()
            : base("name=GostenovaKREntities")
        {
        }
